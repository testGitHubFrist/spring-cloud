...
public class UserSignDemo {
    ...
    /** * 获取当月首次签到日期 * * @param uid 用户ID * @param date 日期 * @return 首次签到日期 */
    ...
    /** * 获取当月的签到情况 * * @param uid 用户ID * @param date 日期 * @return Key为签到日期，Value为签到状态的Map */
    ...
    public static void main(String[] args) {
        ...
        boolean checkSign = demo.checkSign(1000, today);
        ...
        long MMcount = demo.getSignCount(1000, today);
        System.out.println("本月签到次数：" + MMcount);

        long instancecount = demo.getContinuousSignCount(1000, today);
        System.out.println("连续签到次数：" + instancecount);
